...
int funcmap_get_name(target_ulong pc, target_ulong cr3, std::string &mod_name, std::string &func_name);

void funcmap_insert_function(const char *module, const std::string &fname, target_ulong offset, target_ulong inode_number);
