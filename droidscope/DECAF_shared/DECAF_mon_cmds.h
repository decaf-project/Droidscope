...
{
  .name	  = "module_symbols|ms", 
  .args_type	  = _QEMU_MON_KEY_VALUE("module_name","s") _QEMU_MON_KEY_VALUE("pid","i") _QEMU_MON_KEY_VALUE("base","i"),
  ._QEMU_MON_HANDLER_CMD	  = do_guest_symbols,
  .params 	  = "module_name pid",
  .help	  = "list the symbols of the module with name <module_name> of <pid>"
},
...

{
  ...
  {
	.name		  = "memsave",
	.args_type	  = _QEMU_MON_KEY_VALUE("vaddr","i") _QEMU_MON_KEY_VALUE("size","i") _QEMU_MON_KEY_VALUE("pgd","i") _QEMU_MON_KEY_VALUE("file", "s"),
	._QEMU_MON_HANDLER_CMD = do_memsave,
	.params 	  = "vaddr size dest_file",
	.help		  = "Dumps some guest memory to file, appending if already existant"
  },
