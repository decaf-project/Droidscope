...
class DexFile {
 public:
  ...
  static MemberOffset GetMethodIdsOffset() {
    return OFFSET_OF_OBJECT_MEMBER(DexFile, method_ids_);
  }

          //toremove!
        int getOffsetOfMethodId()
        {
          return offsetof( DexFile, method_ids_ );
           //return (unsigned char*)&(this->method_ids_) - (unsigned char*)this;;
        }
