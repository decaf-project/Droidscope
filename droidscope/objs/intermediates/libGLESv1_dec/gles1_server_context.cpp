...
int gles1_server_context_t::initDispatchByName(void *(*getProc)(const char *, void *userData), void *userData)
{
	...
	glDeleteRenderbuffersOES = (glDeleteRenderbuffersOES_server_proc_t) getProc("glDeleteRenderbuffersOES", userData);
	glGenRenderbuffersOES = (glGenRenderbuffersOES_server_proc_t) getProc("glGenRenderbuffersOES", userData);
	...
	glDeleteFramebuffersOES = (glDeleteFramebuffersOES_server_proc_t) getProc("glDeleteFramebuffersOES", userData);
	glGenFramebuffersOES = (glGenFramebuffersOES_server_proc_t) getProc("glGenFramebuffersOES", userData);
